    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 -left-20 w-96 h-96 bg-ok-soft rounded-full blur-3xl"></div>
            ...
            <div className="w-full max-w-4xl relative">
                ...
                <div className="text-center mb-8 animate-fade-in">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-panel bg-gradient-to-br from-emerald-500 to-teal-500 shadow-2xl shadow-emerald-500/30 mb-6">
                    ...
                    {[1, 2].map((s) => (
                        <div
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all ${step === s
                                ? 'bg-accent/20 border border-accent/25 text-accent'
                                : step > s
                                    ? 'bg-ok-soft border border-emerald-500/50 text-ok'
                ...
                <div className="glass-card p-8 animate-slide-up">
                    {error && (
                        <div className="mb-6 p-4 bg-bad-soft border border-bad/30 rounded-control text-bad text-sm">
                            {error}
                        </div>
                    )}
                    ...
                    {step === 1 && (
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-muted text-sm">{products.length} productos</span>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                                    ...
                                    <button
                                        ...
                                        className="input-glass text-left flex items-center justify-between hover:border-accent/25 transition-colors"
                                    >
                                        <span className={newProduct.extras.length > 0 ? 'text-white' : 'text-muted'}>
                            ...
                            <div className="max-h-80 overflow-y-auto space-y-2">
                                {products.map((product, index) => (
                                    <div
                                        key={index}
                                        className="flex items-center justify-between p-4 bg-raised rounded-control border border-line"
                                    >
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-muted">
                                                ...
                                                {product.extras && product.extras.length > 0 && (
                                                    <span className="text-accent"> • Extras: {product.extras.join(', ')}</span>
                                                )}
                                            </p>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <button
                                                ...
                                                className="p-2 text-bad hover:bg-bad-soft rounded-lg transition-colors"
                                            >
                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {step === 2 && (
                        <div className="space-y-6 text-center">
                            <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-ok-soft mb-4">
                                <svg className="w-12 h-12 text-ok" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p className="text-muted max-w-md mx-auto">
                                Has configurado <span className="text-ink font-medium">{products.length} productos</span> en tu catálogo.
